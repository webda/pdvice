...
public interface CompanyDao {
	...
	/**
	 * 获得一个Company对象,以参数Company对象中不为空的属性作为条件进行查询,返回符合条件的第一条
	 * 
	 * @param obj
	 * @return
	 */
	Company selectCompanyObjSingle(Company obj);
	 ...
	 * @return
	 */
	List<Company> selectCompanyByObj(Company obj);
	 ...
	 * @return
	 */
	int insertNotNullCompany(Company value);
	 ...
	 * @return
	 */
	int deleteCompanyByAssist(Assist assist);
	 ...
	 * @return
	 */
	int updateNotNullCompanyById(Company enti);
	 ...
	 * @return
	 */
	int updateNotNullCompany(@Param("enti") Company value, @Param("assist") Assist assist);
}