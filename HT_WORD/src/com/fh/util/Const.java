...
public class Const {
	...
	public static final String SESSION_APPUSER = "sessionAPPUser";				//session用的用户
	...
	public static final String SESSION_appuserpds = "appuserpds";	
	public static final String SESSION_USERROL = "USERROL";					//用户对象
	public static final String SESSION_USERNAME = "USERNAME";				//用户名
	public static final String SESSION_USERID = "USERID";				//用户名
	public static final String SESSION_APPUSERNAME = "APPUSERNAME";				//学生用户名
	public static final String SESSION_APPUSERID = "APPUSERID";				//学生用户名
	public static final String SESSION_APPUSERbetime = "APPUSERBeginTime";				//学生用户名
	...
	public static final String PAGEUSER	= "admin/config/PAGEUSER.txt";				//分页条数配置路径
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(assets)|(main)|(websocket)|(images)).*";	//不对匹配该值的访问路径拦截（正则）
	...
	public static final Object SESSION_APPUSER_Pd = "SESSION_APPUSER_Pd";
