...
public class AppuserService implements AppuserManager{
	...
	public List<PageData>getopenbookcount(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("AppuserMapper.findopenbookcount", pd);
	}
	...
	public List<PageData>getstuopenbookcount(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("AppuserMapper.stuselectedcoursecount", pd);
	}
	...
	public List<PageData> nochoosecourse(PageData pd)throws Exception{
		return (List<PageData>) dao.findForList("AppuserMapper.nochoosecourse", pd);
	}
	...
	public List<PageData> selectedcourse(PageData pd)throws Exception{
		return (List<PageData>) dao.findForList("AppuserMapper.selectedcourse", pd);
	}
	...
	public List<PageData> findByUsernamelist(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("AppuserMapper.findByUsername", pd);
	}
	...
	public void saveUmulti(PageData pd)throws Exception{
		dao.save("AppuserMapper.addmultiuser", pd);
	}
	...
	public void editsyspreview(PageData pd)throws Exception{
		dao.update("AppuserMapper.editsyson", pd);
	}
	...
	public void editUserinf(PageData pd)throws Exception{
		dao.update("AppuserMapper.editUserinf", pd);
	}
	...
	public void editlogincount(PageData pd)throws Exception{
		dao.update("AppuserMapper.editlogincount", pd);
	}
