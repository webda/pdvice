<%@ page language="java" import="com.fh.util.Jurisdiction,org.apache.shiro.session.Session" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
$( function() {
	 ...
	 <%  
     Session session1 = Jurisdiction.getSession();
     String userid_session = session1.getAttribute("SESSION_USER_id").toString();
		
		 %>
		 
     var USER_ID="<%=userid_session%>"; 
     if(USER_ID=='1')
    	 USER_ID='';
	...
	tab.add( {
		id :'tab1_index1',
		title :"用户管理",
		// url :"<%=basePath%>login_default.do?USER_ID="+USER_ID,
